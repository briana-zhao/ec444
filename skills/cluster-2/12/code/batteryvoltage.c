...
static void alpha_display() {
  ...
  uint16_t numbertable[] = {
    ...
    while (1) {
        ...
        int remainder = 0;
        int voltage_average_temp;
        uint16_t displaybuffer[8];


        voltage_average_temp = voltage_average;
        if (voltage_average_temp > 1000)            //For voltages with 4 digits
        {
            for (int i = 0; i < 3; i++)
            {
                remainder = voltage_average_temp % 10;
                digits[i] = remainder;
                voltage_average_temp = voltage_average_temp - remainder;
                voltage_average_temp = voltage_average_temp / 10;
            }
            digits[3] = voltage_average_temp;
        }
        else if (voltage_average_temp < 1000 && voltage_average_temp > 100)     //For voltages with 3 digits
        {
            for (int i = 0; i < 2; i++)
            {
                remainder = voltage_average_temp % 10;
            ...
            digits[2] = voltage_average_temp;
            digits[3] = 0;
        }
        else if (voltage_average_temp < 100)        //For voltages with 2 digits
        {
            remainder = voltage_average_temp % 10;
            digits[0] = remainder;
            voltage_average_temp = voltage_average_temp - remainder;
            voltage_average_temp = voltage_average_temp / 10;
            digits[1] = voltage_average_temp;
            digits[2] = 0;
            digits[3] = 0;
        }
...
void app_main(void)
{
    ...
    //Enable the alphanumeric display
    ...
    while (1) {
        ...
        printf("Voltage reading (average): %dmV\n", voltage_average);
