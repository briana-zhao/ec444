...
void app_main(void)
{
    ...
    while (1) {
        ...
        for (int j = 0; j < 20; j++)        //Sum up all the voltage readings from the past second
        {
        ...
        //printf("Voltage: %.2f Distance: %.2f m\n", voltage_average, distance_m);
