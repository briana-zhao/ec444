...
int my_time = 0;                    //keeps track of time
int timer_initial_start = 0;        //start stopwatch after an initial button press
...
static void stopwatch_task(void *arg) {
    while (1) {

        if (button_flag)
        {
            timer_initial_start = 1; //Start the timer
        }

        if (button_flag || my_time == 100)
        {
            my_time = 0;            //If the button is pushed or the stopwatch reaches 100, reset back to 0
        }

        button_flag = 0;            //Reset the button flag back to 0
...
static void test_alpha_display() {
    ...
    while (1) {
        ...
        int least_sig_digit, most_sig_digit;
        ...
        {
            least_sig_digit = my_time % 10;
            most_sig_digit = (my_time - least_sig_digit) / 10;
        }

        displaybuffer[0] = 0;
        displaybuffer[1] = 0;
        displaybuffer[2] = numbertable[most_sig_digit];
        displaybuffer[3] = numbertable[least_sig_digit];
...
void app_main(void) {
    ...
    xTaskCreate(stopwatch_task, "stopwatch_task", 2048, NULL, 5, NULL);
